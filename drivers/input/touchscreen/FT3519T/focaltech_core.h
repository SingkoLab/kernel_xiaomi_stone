...
/*End Modify*/
#if	FTS_TP_SELFTEST
bool start_selftest(int);
extern int fts_tp_selftest_proc_init(void);
extern void fts_tp_selftest_proc_exit(void);
#endif
...
int fts_esdcheck_tp_reset(struct fts_ts_data *ts_data);
