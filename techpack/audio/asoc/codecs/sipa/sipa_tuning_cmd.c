...
#define SIXTH_SIPA_RX_MODULE						(0x1700E900)/* module id */
#define SIXTH_SIPA_RX_ENABLE						(0x8001026)/* parameter id */
#define SIXTH_SIPA_RX_CORE_TOPO						(0x1800EA02)/* parameter id */
#define SIXTH_SIPA_RX_CORE_PARAM					(0x1800EA03)/* parameter id */
